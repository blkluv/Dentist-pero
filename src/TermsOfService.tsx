...
// --- Navbar (same as yours, but with a small tweak for accessibility) ---
const Navbar = () => {
    ...
    <footer className="bg-primary text-white rounded-t-[4rem] px-6 md:px-16 py-16 md:py-24 mt-24 shadow-[0_-20px_50px_rgba(15,23,42,0.1)]">
      <div className="flex flex-col justify-between gap-16 mx-auto max-w-7xl md:flex-row md:gap-8">
        <div className="max-w-sm">
          <div className="mb-4 font-sans text-3xl font-bold tracking-tight text-white">
            ATL Perio Group
          </div>
        ...
        <div className="grid grid-cols-2 gap-12 font-sans text-sm">
          <div className="flex flex-col gap-4 text-white/70">
            <div className="mb-2 font-mono text-xs font-semibold tracking-widest text-white uppercase">
              Practice
            </div>
            <a href="/#philosophy" className="transition-colors link-hover hover:text-accent">
              Philosophy
      ...
      <div className="flex flex-col items-center justify-between gap-4 pt-8 mx-auto mt-24 border-t max-w-7xl border-white/10 md:flex-row">
        <p className="font-mono text-xs text-white/40">
          © {new Date().getFullYear()} ATL Perio Group. All rights reserved.
        </p>
        <div className="flex items-center gap-3 px-4 py-2 border rounded-full shadow-inner bg-white/5 border-white/10">
          <div className="w-2 h-2 rounded-full bg-accent shadow-[0_0_8px_#06B6D4] animate-pulse" />
...
export default function TermsOfService() {
  ...
  useEffect(() => {
    // Force ScrollTrigger to recalculate after the layout is stable
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Add a scroll‑margin to the top so the fixed navbar doesn't cover the heading */}
      <section ref={containerRef} className="max-w-4xl px-6 pt-40 pb-24 mx-auto md:px-16 scroll-mt-32">
        <h1 className="mb-4 font-sans text-4xl font-bold tracking-tight md:text-5xl text-primary">
          Terms of Service
        </h1>
        <p className="mb-12 font-mono text-sm text-primary/60">
        ...
        <div className="space-y-8">
          {[
              ...
              extra: (
                <div className="p-6 mt-4 border bg-primary/5 rounded-2xl border-primary/10">
                  <p className="font-sans text-primary">
                    <strong>Atlanta Periodontal Group</strong>
                  </p>
                  <p className="font-serif text-primary/70">
                    Phone: <a href="tel:+17709945678" className="text-accent hover:underline">
                      (770) 994-5678
                    </a>
                  </p>
                </div>
            ...
            <section key={idx} className="terms-section">
              <h2 className="mb-3 font-sans text-2xl font-bold text-primary">
                {section.title}
              </h2>
